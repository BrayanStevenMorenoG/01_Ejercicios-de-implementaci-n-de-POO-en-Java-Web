...
<body>
    ...
    <nav class="nav">
        <ul class="nav-links">
            <li><a href= "bolsillo?accion=recargaNequi">Recargar</a></li>
            <li><a href= "bolsillo?accion=retiroNequi">Retirar</a></li>
            <li><a href= "bolsillo?accion=consultarNequi">Consultar</a></li>
        </ul>
    </nav>
    <section class="nequi">
