...
<header class="header">
    ...
    <h1 class="titulo">CONSULTA NEQUI</h1>
...
<body>
    <section class="nequi">
        <center><img src="img/nequi-logo.png" alt="Nequi logo" class="imagen2">
        <br><br><br><br>
        <h1 class="titulo">Su saldo es: <%=request.getAttribute("saldo")%></h1>
        </center>
    </section>
