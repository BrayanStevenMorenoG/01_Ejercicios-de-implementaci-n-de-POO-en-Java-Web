...
<body>
    ...
    <header class="header">
        ...
        <h1 class="titulo">RETIRO DE DAVIPLATA</h1>
    ...
    <section class="formularios">
        ...
        <form action="bolsillo" method="post">
            <input class="formulario" type="number" name="retirar" id="numero" placeholder="Ingrese la cantidad de dinero que desea retirar">
            <!-- <input class="boton" type="submit" name="accion" value="Retirar Daviplata"> -->
            <button class="boton" type="submit" name="accion" value="Retirar Daviplata">Retirar</button>
        </section>
        </form>
    </section>
