...
<body>
    ...
    <header class="header">
        <div class="logo">
            <a href= "bolsillo?accion=index"><img src="img/logo.png" alt="Daviplata logo"></a>
        </div>
    ...
    <nav class="nav">
        <ul class="nav-links">
            <li><a href= "bolsillo?accion=recargaDaviplata">Recargar</a></li>
            <li><a href= "bolsillo?accion=retiroDaviplata">Retirar</a></li>
            <li><a href= "bolsillo?accion=consultarDaviplata">Consultar</a></li>
        </ul>
    </nav>

    <section class="daviplata">
        <center><img src="img/daviplata-logo.png" alt="" class="imagen2"></center>
