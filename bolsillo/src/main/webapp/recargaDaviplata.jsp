...
<body>
    ...
    <header class="header">
        ...
        <h1 class="titulo">RECARGA A DAVIPLATA</h1>
    ...
    <section class="formularios">
        ...
        <form action="bolsillo" method="post">
            <input class="formulario" type="numer" name="recargar" id="numero" placeholder="Ingrese la cantidad de dinero que desea recargar">
            <!-- <input class="boton" type="submit" name="accion" value="Recarga Daviplata"> -->
            <button class="boton" type="submit" name="accion" value="Recarga Daviplata">Recargar</button>
        </section>
        </form>
    </section>
